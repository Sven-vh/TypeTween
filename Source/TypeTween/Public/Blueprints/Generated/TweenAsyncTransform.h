...
public:
	UFUNCTION(BlueprintPure, Category = "TypeTween|Config|Transform")
	static FTweenTransformSettings GetSettings(const FTweenTransformHandle& In) {
	...
	UFUNCTION(BlueprintCallable, Category = "TypeTween|Config|Transform")
	static void SetSettings(UPARAM(ref) FTweenTransformHandle& In, FTweenTransformSettings Settings) {
	...
	UFUNCTION(BlueprintCallable, Category = "TypeTween|Control|Transform")
	...
	UFUNCTION(BlueprintPure, Category = "TypeTween|Control|Transform")
